...
/*	PAWS/RTTM data	*/
	...
	u8	saw_unknown:1,	/* Received unknown option		*/
		trimming_ok:1, /* Received TCP_TRIMMING 		*/
		trimming_nack_rcvd:1, /* Received TCP_TRIMMING NACK		*/
		unused:5;
	u8	num_sacks;	/* Number of SACK blocks		*/
	u16	user_mss;	/* mss requested by user in ioctl	*/
	u16	mss_clamp;	/* Maximal mss, negotiated at connection setup */
	u32 nack_seq;   /* Trimming nack received sequence	*/
};
...
static inline void tcp_clear_options(struct tcp_options_received *rx_opt)
{
	...
	rx_opt->trimming_ok = 0;
	rx_opt->trimming_nack_rcvd = 0;
...
#define TCP_RACK_RECOVERY_THRESH 16
	...
	u8	dup_ack_counter:2,
		...
		trimming_send_nak:1, /* Send NAK flag for TCP_TRIMMING */
		unused:4;
