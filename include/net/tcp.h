...
#define TCPOPT_TRIMMING_PERM	42	 /* Packet trimming permitted */
#define TCPOPT_TRIMMING_NACK	43	 /* Packet trimming NACK*/
...
#define TCP_TRIMMING_QUEUE_NACK 2
#define TCP_TRIMMING_SEEN_NACK 4
